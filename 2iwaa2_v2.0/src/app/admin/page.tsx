    ...
    <main className="min-h-screen bg-zinc-50">
      <div className="mx-auto max-w-4xl px-4 py-10">
        ...
        <p className="mt-2 text-zinc-700">
          مبدئياً: أدخل كلمة مرور الإدارة ثم راجع البلاغات.
        </p>

        <div className="mt-6 grid gap-3 rounded-lg border bg-white p-4">
          <label className="grid gap-1">
            <span className="text-sm text-zinc-600">كلمة مرور الإدارة</span>
            <input
          ...
          <label className="grid gap-1">
            <span className="text-sm text-zinc-600">الحالة</span>
            <select
              className="rounded-md border px-3 py-2"
              value={status}
              onChange={(e) => {
