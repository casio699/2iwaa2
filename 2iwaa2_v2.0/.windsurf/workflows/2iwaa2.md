...
# 2iwaa2 - منصة إيواء (2iwa2) — Plan from A to Z

This document is the single source of truth for building **2iwaa2**, a Lebanese crisis/displacement assistance platform.

Principles:
- **Arabic-first** UX (Lebanese dialect as a fallback), **RTL-first**.
- **Fast MVP**, then iterate by priority.
- **Free/low-cost** infrastructure and services.
- **Safety & trust**: moderation, audit trails, minimal PII, abuse prevention.
- **Resilience**: offline-friendly PWA, graceful degradation.
